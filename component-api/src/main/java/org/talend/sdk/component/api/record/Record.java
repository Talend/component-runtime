...
public interface Record {
    ...
    interface Builder {
        ...
        default Builder withInt(String name, int value) {
            return this.withInt(name, Integer.valueOf(value));
        }

        Builder withInt(Schema.Entry entry, Integer value);

        default Builder withInt(Schema.Entry entry, int value) {
            return this.withInt(entry, Integer.valueOf(value));
        }

        Builder withLong(String name, Long value);

        default Builder withLong(String name, long value) {
            return this.withLong(name, Long.valueOf(value));
        }

        Builder withLong(Schema.Entry entry, Long value);

        default Builder withLong(Schema.Entry entry, long value) {
            return this.withLong(entry, Long.valueOf(value));
        }
        ...
        default Builder withDouble(String name, double value) {
            return this.withDouble(name, Double.valueOf(value));
        }

        Builder withDouble(Schema.Entry entry, Double value);

        default Builder withDouble(Schema.Entry entry, double value) {
            return this.withDouble(entry, Double.valueOf(value));
        }
