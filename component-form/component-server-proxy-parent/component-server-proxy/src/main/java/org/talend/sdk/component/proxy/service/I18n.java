...
public interface I18n {
    ...
    String actionServiceChildrenTypePropertyDisplayName(Locale locale);
    ...
    class Registrar {
        ...
        @ApplicationScoped
        public I18n i18n() {
            return new InternationalizationServiceFactory()
                    .create(I18n.class, Thread.currentThread().getContextClassLoader());
        }

        // copied from component-manager, just fropped @Language for this app
        private static class InternationalizationServiceFactory {
                ...
                return api
                        .cast(Proxy
                                .newProxyInstance(loader, new Class<?>[] { api },
                                        new InternationalizedHandler(api.getName() + '.',
            ...
            private static class InternationalizedHandler implements InvocationHandler {
                ...
                private Function<Object[], Object[]> createParameterFactory(final Method method) {
                    ...
                    for (int i = 0; i < parameters.length; i++) {
                        if (parameters[i].getType() != Locale.class) {
                            included.add(i);
                        }
                    }
                ...
                private String getTemplate(final Locale locale, final Method method) {
                    final ResourceBundle bundle = bundles
                            .computeIfAbsent(locale, l -> ResourceBundle
                                    .getBundle(messages, l, Thread.currentThread().getContextClassLoader()));
