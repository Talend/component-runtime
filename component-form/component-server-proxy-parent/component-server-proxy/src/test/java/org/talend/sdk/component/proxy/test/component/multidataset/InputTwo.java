...
@PartitionMapper(name = "MultiDataSetInputTwo", family = "MultiDatasetFamily")
@Icon(value = Icon.IconType.CUSTOM, custom = "myicon")
public class InputTwo {

    private DataSetTwo dataSetTwo;

    public InputTwo(@Option DataSetTwo dataSetTwo) {
