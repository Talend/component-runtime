 ...
 */
package org.talend.component.beam.it.clusterserialization;
...
import org.talend.component.runtime.beam.TalendFn;
import org.talend.component.runtime.beam.TalendIO;
...
public class Main {
    ...
    public interface Config extends PipelineOptions {
        ...
        @Default.String("/tmp/org.talend.component.beam.it.clusterserialization.Main.input")
        String getInputFile();
