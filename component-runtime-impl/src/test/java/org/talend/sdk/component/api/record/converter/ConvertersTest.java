...
/**
 * Test schema to json & json to schema for SchemaImpl implementation
 */
public class ConvertersTest {

    private static final RecordBuilderFactory factory = new RecordBuilderFactoryImpl("test");
    ...
    void schemaJsonTest(final Schema schema) {
        JsonObject jsonObject = toJson.toJson(schema);
        Schema result = toSchema.toSchema(jsonObject);
        Assertions.assertEquals(schema, result);
        JsonObject jsonCopy = toJson.toJson(result);
