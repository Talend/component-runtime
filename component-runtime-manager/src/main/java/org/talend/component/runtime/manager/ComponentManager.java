 ...
 */
package org.talend.component.runtime.manager;
...
import org.talend.component.classloader.ConfigurableClassLoader;
import org.talend.component.container.Container;
import org.talend.component.container.ContainerListener;
import org.talend.component.container.ContainerManager;
import org.talend.component.dependencies.maven.MvnDependencyListLocalRepositoryResolver;
import org.talend.component.jmx.JmxManager;
import org.talend.component.runtime.base.Delegated;
import org.talend.component.runtime.input.LocalPartitionMapper;
import org.talend.component.runtime.input.Mapper;
import org.talend.component.runtime.input.PartitionMapperImpl;
import org.talend.component.runtime.internationalization.InternationalizationServiceFactory;
import org.talend.component.runtime.manager.asm.ProxyGenerator;
import org.talend.component.runtime.manager.extension.ComponentContextImpl;
import org.talend.component.runtime.manager.processor.AdvancedProcessorImpl;
import org.talend.component.runtime.manager.processor.SubclassesCache;
import org.talend.component.runtime.manager.proxy.JavaProxyEnricherFactory;
import org.talend.component.runtime.manager.reflect.ParameterModelService;
import org.talend.component.runtime.manager.reflect.ReflectionService;
import org.talend.component.runtime.manager.service.ResolverImpl;
import org.talend.component.runtime.manager.xbean.KnownClassesFilter;
import org.talend.component.runtime.manager.xbean.KnownJarsFilter;
import org.talend.component.runtime.manager.xbean.NestedJarArchive;
import org.talend.component.runtime.output.data.AccessorCache;
...
import org.talend.component.spi.component.ComponentExtension;
...
public class ComponentManager implements AutoCloseable {
    ...
    private final Filter classesFilter = Filters.prefixes("org.talend.component.api.", "org.talend.component.spi.",
            "javax.annotation.", "org.talend.component.classloader.", "org.talend.component.runtime.", "org.slf4j.",
    ...
    public void addCallerAsPlugin() {
        try {
            ...
            final Class<?> jarMarker = tmpLoader.loadClass(Stream.of(stackTrace)
                    .filter(c -> !c.getClassName().startsWith("org.talend.component.runtime.manager.")
                            && !c.getClassName().startsWith("org.talend.component.runtime.standalone.")
                            && !c.getClassName().startsWith("org.talend.component.runtime.avro.")
    ...
    public Optional<org.talend.component.runtime.output.Processor> findProcessor(final String plugin, final String name,
            final int version, final Map<String, String> configuration) {
        return find(
                                                        ...
                                                        .map(proc -> proc.getInstantiator()
                                                                .apply(configuration == null ? null
                                                                        : proc.getMigrationHandler().migrate(version,
                                                                                configuration)))
                                                        .map(org.talend.component.runtime.output.Processor.class::cast))
                                        .findFirst().flatMap(identity());
    }
    ...
    private class ComponentMetaBuilder implements ModelListener {
        ...
        public void onProcessor(final Class<?> type, final Processor processor) {
            ...
            final Function<Map<String, String>, org.talend.component.runtime.output.Processor> instantiator = context
                    .getOwningExtension() != null
                    && context.getOwningExtension().supports(org.talend.component.runtime.output.Processor.class)
                            ? config -> executeInContainer(plugin,
                                    () -> context.getOwningExtension().convert(
                                            ...
                                            org.talend.component.runtime.output.Processor.class))
