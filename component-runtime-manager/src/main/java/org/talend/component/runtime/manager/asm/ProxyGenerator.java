 ...
 */
package org.talend.component.runtime.manager.asm;
...
public class ProxyGenerator implements Serializable {
    ...
    private void createSerialisation(final ClassWriter cw, final String pluginId, final String key) {
        ...
        mv.visitTypeInsn(NEW, "org/talend/component/runtime/serialization/SerializableService");
        mv.visitInsn(DUP);
        mv.visitLdcInsn(pluginId);
        mv.visitLdcInsn(key);
        mv.visitMethodInsn(INVOKESPECIAL, "org/talend/component/runtime/serialization/SerializableService", "<init>",
    ...
    public Class<?> subclass(final ClassLoader loader, final Class<?> classToProxy) {
        ...
        cw.visitField(ACC_PRIVATE, "this$map", "Lorg/talend/component/api/processor/data/ObjectMap;", null, null).visitEnd();

        {
            final MethodVisitor getObjectMap = cw.visitMethod(ACC_PUBLIC, "getObjectMap", "()Lorg/talend/component/api/processor/data/ObjectMap;", null, null);
            getObjectMap.visitCode();
            getObjectMap.visitVarInsn(ALOAD, 0);
            getObjectMap.visitFieldInsn(GETFIELD, classFileName, "this$map", "Lorg/talend/component/api/processor/data/ObjectMap;");
