...
import org.talend.components.jmx.JmxManager;
import org.talend.components.runtime.base.Delegated;
import org.talend.components.runtime.input.LocalPartitionMapper;
import org.talend.components.runtime.input.Mapper;
import org.talend.components.runtime.input.PartitionMapperImpl;
...
import org.talend.components.runtime.manager.processor.AdvancedProcessorImpl;
import org.talend.components.runtime.manager.processor.SubclassesCache;
import org.talend.components.runtime.manager.proxy.JavaProxyEnricherFactory;
import org.talend.components.runtime.manager.reflect.ParameterModelService;
import org.talend.components.runtime.manager.reflect.ReflectionService;
import org.talend.components.runtime.manager.service.ResolverImpl;
import org.talend.components.runtime.manager.xbean.KnownClassesFilter;
import org.talend.components.runtime.manager.xbean.KnownJarsFilter;
import org.talend.components.runtime.manager.xbean.NestedJarArchive;
...
import org.talend.components.runtime.visitor.ModelListener;
import org.talend.components.runtime.visitor.ModelVisitor;
...
public class ComponentManager implements AutoCloseable {
    ...
    private final Filter classesFilter = Filters.prefixes("org.talend.component.api.", "org.talend.components.spi.",
            "javax.annotation.", "org.talend.components.classloader.", "org.talend.components.runtime.", "org.slf4j.",
    ...
    public void addCallerAsPlugin() {
        try {
            ...
            final Class<?> jarMarker = tmpLoader.loadClass(Stream.of(stackTrace)
                    .filter(c -> !c.getClassName().startsWith("org.talend.components.runtime.manager.")
                            && !c.getClassName().startsWith("org.talend.components.runtime.standalone.")
                            && !c.getClassName().startsWith("org.talend.components.runtime.avro.")
    ...
    public Optional<org.talend.components.runtime.output.Processor> findProcessor(final String plugin, final String name,
            final int version, final Map<String, String> configuration) {
        return find(
                                                        ...
                                                        .map(proc -> proc.getInstantiator()
                                                                .apply(configuration == null ? null
                                                                        : proc.getMigrationHandler().migrate(version,
                                                                                configuration)))
                                                        .map(org.talend.components.runtime.output.Processor.class::cast))
                                        .findFirst().flatMap(identity());
    }
    ...
    private class ComponentMetaBuilder implements ModelListener {
        ...
        public void onProcessor(final Class<?> type, final Processor processor) {
            ...
            final Function<Map<String, String>, org.talend.components.runtime.output.Processor> instantiator = context
                    .getOwningExtension() != null
                    && context.getOwningExtension().supports(org.talend.components.runtime.output.Processor.class)
                            ? config -> executeInContainer(plugin,
                                    () -> context.getOwningExtension().convert(
                                            ...
                                            org.talend.components.runtime.output.Processor.class))
