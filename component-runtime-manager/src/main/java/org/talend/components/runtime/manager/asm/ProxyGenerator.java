...
public class ProxyGenerator implements Serializable {
    ...
    private void createSerialisation(final ClassWriter cw, final String pluginId, final String key) {
        ...
        mv.visitTypeInsn(NEW, "org/talend/components/runtime/serialization/SerializableService");
        mv.visitInsn(DUP);
        mv.visitLdcInsn(pluginId);
        mv.visitLdcInsn(key);
        mv.visitMethodInsn(INVOKESPECIAL, "org/talend/components/runtime/serialization/SerializableService", "<init>",
