...
import org.talend.component.runtime.manager.asm.PluginGenerator;
import org.talend.component.runtime.manager.serialization.DynamicContainerFinder;
...
public class ComponentManagerTest {
    ...
    private org.talend.component.runtime.output.Processor copy(
            final org.talend.component.runtime.output.Processor processor, final ClassLoader loader)
        ...
        try (final ObjectInputStream ois = new EnhancedObjectInputStream(new ByteArrayInputStream(baos.toByteArray()), loader)) {
            return org.talend.component.runtime.output.Processor.class.cast(ois.readObject());
        }
    }

    private void runProcessorLifecycle(final Object model, final org.talend.component.runtime.output.Processor proc) {
        proc.start();
        proc.beforeGroup();
