...
public class ComponentManagerTest {
    ...
    private org.talend.components.runtime.output.Processor copy(
            final org.talend.components.runtime.output.Processor processor, final ClassLoader loader)
        ...
        try (final ObjectInputStream ois = new EnhancedObjectInputStream(new ByteArrayInputStream(baos.toByteArray()), loader)) {
            return org.talend.components.runtime.output.Processor.class.cast(ois.readObject());
        }
    }

    private void runProcessorLifecycle(final Object model, final org.talend.components.runtime.output.Processor proc) {
        proc.start();
        proc.beforeGroup();
