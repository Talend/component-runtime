...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        final ToleratingErrorHandler errorHandler =
                new ToleratingErrorHandler(Integer.getInteger("talend.job." + jobName + ".error.max"));
