...
@Processor(family = "bulkProcessor", name = "BulkProcessorWithAutoLayoutConfig")
public class BulkProcessorWithAutoLayoutConfig implements Serializable {

    public BulkProcessorWithAutoLayoutConfig(@Option("configuration") final Config config) {
    }
