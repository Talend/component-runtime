...
class DocumentationResourceImplTest {
    ...
    void selectByIdUsingComments() {
        ...
        assertEquals("super my component", impl.selectById("my", content, DocumentationResourceImpl.DocumentationSegment.DESCRIPTION).trim());
        ...
        assertEquals("== my\n" +
                ...
                "|===\n" +
                "\n" +
                "//configuration_end", impl.selectById("my", content, DocumentationResourceImpl.DocumentationSegment.ALL).trim());
        assertEquals("super my component2", impl.selectById("my2", content, DocumentationResourceImpl.DocumentationSegment.DESCRIPTION).trim());
        assertEquals("[cols=\"d,d,m,a,e,d\",options=\"header\"]\n" +
                "|===\n" +
                "|Display Name|Description|Default Value|Enabled If|Configuration Path|Configuration Type\n" +
                "|ds|ds configuration|-|Always enabled|ds|dataset\n" +
        ...
        assertEquals("== my2\n" +
                ...
                "|===\n" +
                "\n" +
                "//configuration_end", impl.selectById("my2", content, DocumentationResourceImpl.DocumentationSegment.ALL).trim());
        assertEquals("super my componentv3", impl.selectById("my3", content, DocumentationResourceImpl.DocumentationSegment.DESCRIPTION).trim());
        assertEquals("[cols=\"d,d,m,a,e,d\",options=\"header\"]\n" +
                "|===\n" +
                "|Display Name|Description|Default Value|Enabled If|Configuration Path|Configuration Type\n" +
                "|datastore|the datastore|-|Always enabled|ds.datastore|datastore\n" +
        ...
        assertEquals("== my2\n" +
                ...
                "|===\n" +
                "\n" +
                "//configuration_end", impl.selectById("my3", content, DocumentationResourceImpl.DocumentationSegment.ALL).trim());
    }
