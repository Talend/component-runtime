...
class SecuredFilterTest {
    ...
    private final EndpointSecurityService service = new EndpointSecurityService() {

        {
            try {
                final Field configuration = EndpointSecurityService.class.getDeclaredField("configuration");
    ...
    private void doInit() {
        try {
            final Method init = EndpointSecurityService.class.getDeclaredMethod("init");
    ...
    private final SecuredFilter filter = new SecuredFilter() {
        ...
        {
            try {
                final Field configuration = SecuredFilter.class.getDeclaredField("endpointSecurityService");
                configuration.setAccessible(true);
                configuration.set(this, service);
            } catch (final Exception e) {
                fail(e.getMessage());
            }
        }
