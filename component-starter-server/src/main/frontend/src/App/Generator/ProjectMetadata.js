				...
				<div className={theme.main}>
						...
						<div>
							...
							<Help
								...
								content={
									<span>
										<p>
											Maven is the most commonly used build tool and Talend Component Kit integrates
											with it smoothly.
										</p>
										<p>
					...
					<div className={theme['form-row']}>
						{!!this.state.configuration && (
							<FacetSelector
								facets={this.state.configuration.facets}
								selected={this.state.project.facets}
							/>
						)}
					</div>
					...
					<div className={theme['form-row']}>
						...
						<form noValidate onSubmit={e => e.preventDefault()}>
								...
								<Help
									...
									content={
										<span>
											...
											<p>
												<Icon name="talend-info-circle" /> It is recommended to use a single family
												name per component module. The name must be a valid java name (no space,
												special characters, ...).
											</p>
										</span>
									}
							...
							<div className="field">
								...
								<Help
									...
									content={
										<span>
											...
											<p>
												It is recommended to use a two level category. The first level is generally
												very general and the second one is close to the family name.
											</p>
								...
								/>
								<CategorySelector
									initialValue={this.state.project.category}
								...
								<Help
									...
									content={
										<span>
											...
											<p>
												Generally this generator is used for a first version so the default should
							...
							<div className="field">
								...
								<Help
									...
									content={
										<span>
											<p>
												Giving a human readable name to the project is more friendly in an IDE or
