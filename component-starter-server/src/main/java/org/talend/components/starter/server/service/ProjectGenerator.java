...
import org.talend.components.starter.server.service.event.CreateProject;
...
import org.talend.components.starter.server.service.facet.component.ComponentGenerator;
...
public class ProjectGenerator {
    ...
    public void generate(final ProjectRequest request, final OutputStream outputStream) {
        ...
        onCreate.fire(new CreateProject(
                request.getBuildConfiguration().getGroup() + ':' + request.getBuildConfiguration().getArtifact(), facets));
    }
}
