...
class ProjectResourceTest {
    ...
    void emptyMavenProject(final WebTarget target) throws IOException {
        ...
        assertEquals(resourceFileToString("generated/ProjectResourceTest/emptyProject/pom.xml")
                .replace("@runtime.version@", versions.getKit())
                .replace("@api.version@", versions.getApiKit()), files.get("application/pom.xml"));
    }
    ...
    void wadlFacetMaven(final WebTarget target) throws IOException {
        ...
        Stream
                .of("    <dependency>\n" + "      <groupId>org.apache.cxf</groupId>\n"
                        + "      <artifactId>cxf-rt-rs-client</artifactId>\n" + "      <version>" + versions.getCxf()
                        + "</version>\n" + "      <scope>compile</scope>\n" + "    </dependency>",
                        "      <plugin>\n" + "        <groupId>org.apache.cxf</groupId>\n"
                                + "        <artifactId>cxf-wadl2java-plugin</artifactId>\n" + "        <version>"
                                + versions.getCxf() + "</version>\n" + "        <executions>\n"
    ...
    void wadlFacetGradle(final WebTarget target) throws IOException {
        ...
        Stream
                .of("apply plugin: 'nebula.provided-base'\n" + "apply plugin: 'org.talend.sdk.component'\n"
                        ...
                        + "    classpath \"org.talend.sdk.component:gradle-talend-component:" + versions.getKit()
                        + "\"\n" + "    classpath \"org.apache.cxf:cxf-tools-wadlto-jaxrs:" + versions.getCxf() + "\"\n"
                        + "  }\n" + "}\n" + "\n" + "repositories {\n" + "  mavenLocal()\n" + "  mavenCentral()\n"
                        + "}\n" + "\n" + "group = 'com.component'\n"
                        ...
                        + versions.getApiKit() + "'\n"
                        + "  compile group: 'org.apache.cxf', name: 'cxf-rt-rs-client', version: '" + versions.getCxf()
                        + "'\n" + "}")
