    ...
    void wadlFacetMaven(final WebTarget target) throws IOException {
        ...
        Stream
                .of("    <dependency>\n" + "      <groupId>org.apache.cxf</groupId>\n"
                        + "      <artifactId>cxf-rt-rs-client</artifactId>\n" + "      <version>" + Versions.CXF
                        + "</version>\n" + "      <scope>compile</scope>\n" + "    </dependency>",
                        "      <plugin>\n" + "        <groupId>org.apache.cxf</groupId>\n"
                                + "        <artifactId>cxf-wadl2java-plugin</artifactId>\n" + "        <version>"
                                + Versions.CXF + "</version>\n" + "        <executions>\n" + "          <execution>\n"
    ...
    void wadlFacetGradle(final WebTarget target) throws IOException {
        ...
        Stream
                .of("apply plugin: 'nebula.provided-base'\n" + "apply plugin: 'org.talend.sdk.component'\n"
                        ...
                        + "    classpath \"org.apache.cxf:cxf-tools-wadlto-jaxrs:" + Versions.CXF + "\"\n" + "  }\n"
                        + "}\n" + "\n" + "repositories {\n" + "  mavenLocal()\n" + "  mavenCentral()\n" + "}\n" + "\n"
                        + "group = 'com.component'\n"
                        ...
                        + Versions.API_KIT + "'\n"
                        + "  compile group: 'org.apache.cxf', name: 'cxf-rt-rs-client', version: '" + Versions.CXF
                        + "'\n" + "}")
