...
public class ProcessManager implements AutoCloseable {
    ...
    public synchronized void start() {
        ...
        final String[] arguments = Stream.of(System.getProperty("component.java.arguments", "").split(" "))
            .map(String::trim).filter(o -> !o.isEmpty()).toArray(String[]::new);

        final File log4j2Config =
            Stream.of(new File(studioConfigDir, "log4j2-components.xml"), new File(studioConfigDir, "log4j2.xml"))
