            ...
            try {
                ...
                default:
                    throw new IllegalAccessException(
                            String.format("Invalid type: %s (%s) with value: %s. .", fieldType, studioType, raw));
                }
    ...
    private Schema inferSchema(final Object data, final RecordBuilderFactory factory) {
        ...
        Arrays.stream(data.getClass().getFields()).forEach(field -> {
            try {
                ...
                case StudioTypes.BIGDECIMAL:
                    schema
                            .withEntry(toEntry(name, STRING, originalDbColumnName, isNullable, comment, isKey, length,
                ...
                case StudioTypes.BYTE:
                    schema
                            .withEntry(toEntry(name, INT, originalDbColumnName, isNullable, comment, isKey, null, null,
                                    defaultValue, null, studioType));
                    break;
                case StudioTypes.LONG:
                    schema
                            .withEntry(toEntry(name, LONG, originalDbColumnName, isNullable, comment, isKey, null, null,
                                    defaultValue, null, studioType));
                    break;
                case StudioTypes.FLOAT:
                    schema
                            .withEntry(toEntry(name, FLOAT, originalDbColumnName, isNullable, comment, isKey, length,
                                    precision, defaultValue, null, studioType));
                    break;
                case StudioTypes.DOUBLE:
                    schema
                            .withEntry(toEntry(name, DOUBLE, originalDbColumnName, isNullable, comment, isKey, length,
                                    precision, defaultValue, null, studioType));
                    break;
                case StudioTypes.BOOLEAN:
                    schema
                            .withEntry(toEntry(name, BOOLEAN, originalDbColumnName, isNullable, comment, isKey, null,
                                    null, defaultValue, null, studioType));
                    break;
                case StudioTypes.DATE:
                    schema
                            .withEntry(toEntry(name, DATETIME, originalDbColumnName, isNullable, comment, isKey, null,
                                    null, defaultValue, pattern, studioType));
                    break;
                case StudioTypes.BYTE_ARRAY:
                    schema
                            .withEntry(toEntry(name, BYTES, originalDbColumnName, isNullable, comment, isKey, null,
                                    null, defaultValue, null, studioType));
                    break;
                case StudioTypes.DYNAMIC:
                    final Dynamic dynamic = Dynamic.class.cast(raw);
                    dynamic.metadatas.forEach(meta -> {
                        ...
                        case StudioTypes.CHARACTER:
                            schema
                                    .withEntry(toEntry(metaName, STRING, metaOriginalName, metaIsNullable, comment,
                        ...
                        case StudioTypes.BYTE_ARRAY:
                            schema
                                    .withEntry(toEntry(metaName, BYTES, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, null, null, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.BYTE:
                        case StudioTypes.SHORT:
                        case StudioTypes.INTEGER:
                            schema
                                    .withEntry(toEntry(metaName, INT, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, null, null, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.LONG:
                            schema
                                    .withEntry(toEntry(metaName, LONG, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, null, null, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.FLOAT:
                            schema
                                    .withEntry(toEntry(metaName, FLOAT, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, metaLength, metaPrecision, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.DOUBLE:
                            schema
                                    .withEntry(toEntry(metaName, DOUBLE, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, metaLength, metaPrecision, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.BOOLEAN:
                            schema
                                    .withEntry(toEntry(metaName, BOOLEAN, metaOriginalName, metaIsNullable, comment,
                                            metaIsKey, null, null, defaultValue, null, metaStudioType));
                            break;
                        case StudioTypes.DATE:
                            schema
                                    .withEntry(toEntry(metaName, DATETIME, metaOriginalName, metaIsNullable, comment,
