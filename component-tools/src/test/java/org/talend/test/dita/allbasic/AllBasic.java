 ...
 */
package org.talend.test.dita.allbasic;
...
@Version
@Icon(FILE_JOB_O)
@Processor(family = "dita", name = "AllBasic")
public class AllBasic {

    public AllBasic(@Option("configuration") final AllBasicConfig config) {
        // no-op
    }
    ...
    @Data
    @GridLayout({ @GridLayout.Row({ "param1", "param2" }), @GridLayout.Row("param3"), @GridLayout.Row("param6") })
    @Documentation("Entry of documentation")
    public static class AllBasicConfig {
    ...
    @Data
    @DataSet
    @GridLayout({ @GridLayout.Row("param7"), @GridLayout.Row("param8"), @GridLayout.Row("param11") })
    ...
    @Data
    @DataStore
    @GridLayout({ @GridLayout.Row("param12"), @GridLayout.Row("param13"), @GridLayout.Row("param14") })
