...
@Version
@Icon(FILE_JOB_O)
@Processor(family = "dita", name = "Hidden")
public class Hidden {

    public Hidden(@Option("configuration") final HiddenConfig config) {
        // no-op
    }
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param3"), @GridLayout.Row("param6") })
    @GridLayout(names = ADVANCED,
            value = { @GridLayout.Row("param1"), @GridLayout.Row("param2"), @GridLayout.Row("param6") })
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param4") })
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param5") })
    ...
    @Data
    @DataSet
    @GridLayout({ @GridLayout.Row("param7"), @GridLayout.Row("param11") })
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param8"), @GridLayout.Row("param7") })
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param9") })
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param10") }) // this one should be hidden
    public static class Complex2 {
        ...
        @Option
        @Documentation("Param 5 in complex2")
        public Integer param10;
    }

    @Data
    @DataStore
    @GridLayout({ @GridLayout.Row("param12") })
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param13"), @GridLayout.Row("param14") })
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param15") }) // This one should be hidden
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param16") })
