...
@Version
@Icon(FILE_JOB_O)
@Processor(family = "dita", name = "NoDatasetDatastore")
public class NoDatasetDatastore {

    public NoDatasetDatastore(@Option("configuration") final NoLayoutConfig config) {
        // no-op
    }
