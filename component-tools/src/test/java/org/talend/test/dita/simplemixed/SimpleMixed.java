 ...
 */
package org.talend.test.dita.simplemixed;
...
@Version
@Icon(FILE_JOB_O)
@Processor(family = "dita", name = "SimpleMixed")
public class SimpleMixed {

    public SimpleMixed(@Option("configuration") final MixedConfig config) {
        // no-op
    }
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param4"), @GridLayout.Row("param5") })
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param9"), @GridLayout.Row("param10") })
    ...
    @Data
    @DataStore
    @GridLayout({ @GridLayout.Row("param14") })
    @GridLayout(names = ADVANCED, value = { @GridLayout.Row("param12"), @GridLayout.Row("param13") })
    ...
    @Data
    @GridLayout({ @GridLayout.Row("param15"), @GridLayout.Row("param16") })
