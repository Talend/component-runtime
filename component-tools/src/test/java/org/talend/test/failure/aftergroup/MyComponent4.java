...
@Version
@Icon(FILE_JOB_O)
@Processor(family = "test", name = "my4")
public class MyComponent4 implements Serializable {

    public MyComponent4(@Option("configuration") final MyConfig config) {
        // no-op
    }
    ...
    @AfterGroup
    public void afterGroup(@Output final OutputEmitter<Foo> main, @LastGroup boolean last) {
