 ...
 */
package org.talend.test.failure.checkpoint;
...
import org.talend.test.valid.structure.MyComponentWithStructure;
...
public class InputCheckpoint implements Serializable {
    ...
    private final MyComponentWithStructure.MyDataSet dataSet;
