...
Mark a method as returning a Schema resulting from an input one and action of a processor for an outgoing branch. `value' name should match the connector's name.

- Type: `processor_schema`
- API: `@org.talend.sdk.component.api.service.schema.DiscoverProcessorSchema`
