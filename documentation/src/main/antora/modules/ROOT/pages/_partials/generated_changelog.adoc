...
- link:https://jira.talendforge.org/browse/TCOMP-1720[TCOMP-1720^]: Changing the version breaks deployment to Studio
...
- link:https://jira.talendforge.org/browse/TCOMP-1681[TCOMP-1681^]: Make ESB Studio job export TaCoKit compliant
