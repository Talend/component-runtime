...
- link:https://jira.talendforge.org/browse/TCOMP-2104[TCOMP-2104^]: Header link should be linked to latest path
- link:https://jira.talendforge.org/browse/TCOMP-2105[TCOMP-2105^]: Upgrade Tomcat to 9.0.60
...
- link:https://jira.talendforge.org/browse/TCOMP-2110[TCOMP-2110^]: Replace log4j by reload4j
