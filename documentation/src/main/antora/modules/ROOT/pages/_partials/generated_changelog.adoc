...
- link:https://jira.talendforge.org/browse/TCOMP-2135[TCOMP-2135^]: Component server tester in non interactive mode link:search.html?query=component-server[component-server^,role='dockey'] link:search.html?query=maven-plugin[maven-plugin^,role='dockey'] link:search.html?query=testing[testing^,role='dockey']
