...
- link:https://jira.talendforge.org/browse/TCOMP-1811[TCOMP-1811^]: Record Builder API should work with Object not primitive
...
- link:https://jira.talendforge.org/browse/TCOMP-1820[TCOMP-1820^]: API documentation is broken
