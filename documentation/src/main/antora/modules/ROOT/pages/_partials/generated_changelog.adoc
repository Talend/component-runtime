...
- link:https://jira.talendforge.org/browse/TCOMP-2412[TCOMP-2412^]: Upgrade org.apache.tomcat:tomcat-catalina to 9.0.73

== Version 1.38.8

=== Work Item

- link:https://jira.talendforge.org/browse/TCOMP-2327[TCOMP-2327^]: Upgrade cxf to 3.4.10
- link:https://jira.talendforge.org/browse/TCOMP-2328[TCOMP-2328^]: Upgrade woodstox-core to 6.4.0

== Version 1.38.7

=== Work Item

- link:https://jira.talendforge.org/browse/TCOMP-2294[TCOMP-2294^]: Upgrade batik to 1.16
- link:https://jira.talendforge.org/browse/TCOMP-2295[TCOMP-2295^]: Upgrade tomcat to 9.0.68
