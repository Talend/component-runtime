...
talend.component.server.icon.paths:: Default value: `%s_icon32.png,icons/%s_icon32.png,icons/png/%s_icon32.png`. These patterns are used to find the icons in the classpath(s).
