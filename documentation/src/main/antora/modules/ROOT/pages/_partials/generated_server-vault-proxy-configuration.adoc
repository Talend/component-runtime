...
talend.vault.cache.vault.auth.roleId:: The vault role identifier to use to log in.
talend.vault.cache.vault.auth.secretId:: The vault secret identifier to use to log in.
