...
image:mvn_clean_install.png[Maven clean install,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/mvn_clean_install.png",70%]
