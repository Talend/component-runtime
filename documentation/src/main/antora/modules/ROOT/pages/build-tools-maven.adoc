= xref:build-tools-maven.adoc[Maven Plugin]
:page-partial:
...
Testing the rendering of your component configuration into the Studio requires deploying the component in Talend Studio (refer to link:studio.html[Studio Documentation].
