...
==== Tip: change the UI bundle

If you built a custom UI (js+css) bundle and want to test it in the webapp
you can configure it in the pom.xml:
...
IMPORTANT: this is a very advanced feature, ensure to know why you use it if you do. It is recommended to not use it
until a framework developper encourages you to do so.

== Generating inputs or outputs

WARNING: this goal is deprecated and can be deleted in a future release.
