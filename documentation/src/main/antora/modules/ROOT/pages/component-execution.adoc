...
....
////
image:deployment-diagram.png[Deployment diagram,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/deployment-diagram.png",60%]
...
....
////
image:driver-processing-workflow.png[Driver processing workflow,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/driver-processing-workflow.png",40%]
...
....
////
image:worker-processing-workflow.png[Worker processing workflow,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/worker-processing-workflow.png",30%]
