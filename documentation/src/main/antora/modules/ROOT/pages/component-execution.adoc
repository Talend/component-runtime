...
....
////
image:deployment-diagram.png[Deployment diagram,70%,window="_blank",link="_images/deployment-diagram.png"]
...
....
////
image:driver-processing-workflow.png[Driver processing workflow,70%,window="_blank",link="_images/driver-processing-workflow.png"]
...
....
////
image:worker-processing-workflow.png[Worker processing workflow,70%,window="_blank",link="_images/worker-processing-workflow.png"]
