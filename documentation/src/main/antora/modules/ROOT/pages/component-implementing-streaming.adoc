...
image::starter/starter_enabling_streaming.png[Stream Toggle,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/starter/starter_enabling_streaming.png",80%]
