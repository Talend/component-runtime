...
image::starter/starter_enabling_streaming.png[Stream Toggle,window="_blank",link=self,80%]
...
image:streaming-limits-ui-cloud.png[Stream Toggle,window="_blank",link=self,80%]

- Studio

image:streaming-limits-ui-studio.png[Stream Toggle,window="_blank",link=self,80%]
