...
....
////
image:classloader-layout.png[Classloader layout,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/classloader-layout.png",70%]
