...
....
////
image:classloader-layout.png[Classloader layout,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/classloader-layout.png",70%]
