...
A nested configuration will always migrate itself with any root prefix whereas the component configuration
always roots the full configuration. Typically if your model is the following:
