...
image:batch-processing-maxbatchsize.png[Batch processing,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/batch-processing-maxbatchsize.png",80%]
...
image:batch-processing-group.png[Group batch processing,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/batch-processing-group.png",80%]
...
NOTE: When writing tests for your components, you can force the `maxBatchSize` parameter value by setting it with the following syntax: `<configuration prefix>.$maxBatchSize=10`.
