...
image:batch-processing-maxbatchsize.png[Batch processing,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/batch-processing-maxbatchsize.png",80%]
...
image:batch-processing-group.png[Group batch processing,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/batch-processing-group.png",80%]
