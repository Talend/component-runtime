...
image::datastore_view_intellij.png[Datastore view,window="_blank",link="_images/datastore_view_intellij.png",50%]
...
@Documentation("TODO fill the documentation for this configuration") <3>
...
image::dataset_view_intellij.png[Dataset view,window="_blank",link="_images/dataset_view_intellij.png",50%]
...
@Documentation("TODO fill the documentation for this configuration") <2>
...
image::studio_create_dataset.png[Dataset in Studio,window="_blank",link="_images/studio_create_dataset.png",50%]
...
image::studio_select_predefined_dataset.png[Dataset in Component,window="_blank",link="_images/studio_select_predefined_dataset.png",50%]
