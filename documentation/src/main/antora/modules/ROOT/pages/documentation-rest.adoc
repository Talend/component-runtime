...
The API description is browsable using xref:rest-swagger.adoc[OpenAPI] browser.
...
The tracing rate is configurable by setting the `TRACING_SAMPLING_RATE`cenvironment variable.
