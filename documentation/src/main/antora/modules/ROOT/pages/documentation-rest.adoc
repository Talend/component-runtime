...
public Ui getNewComponentModelForm() {
    return mapper.createFormFor(ComponentModel.class);
}
...
public Ui editComponentModelForm(final @PathParam("id") final String id) {
    ...
    final Ui spec = mapper.createFormFor(ComponentModel.class);
    return Ui.ui()
            .withJsonSchema(spec.getJsonSchema())
            .withUiSchema(spec.getUiSchema())
            .withProperties(component)
            .build();
}
----
