...
|image::gallery/widgets/studio/widget_calendar.png.png[Studio List,40%,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/gallery/widgets/studio/widget_calendar.png.png"]
|image::gallery/widgets/web/widget_calendar.png.png[Web List,100%,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/gallery/widgets/web/widget_calendar.png.png"]
|===
