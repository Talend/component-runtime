...
+
image::intellij/plugin/new-project_1.png[New Talend Project,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij/plugin/new-project_1.png",70%]
