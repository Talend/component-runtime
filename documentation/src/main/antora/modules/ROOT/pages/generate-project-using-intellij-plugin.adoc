...
image::intellij/plugin/new-project_2.png[New Talend Project,window="_blank",link="_images/intellij/plugin/new-project_2.png",70%]

[start=3]
. Once your project is configured, select *Next*, then click *Finish*.

image::intellij/plugin/new-project_3.png[New Talend Project,window="_blank",link="_images/intellij/plugin/new-project_3.png",70%]
