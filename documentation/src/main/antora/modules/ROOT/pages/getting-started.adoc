...
image::input_intellij.png[Input,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/input_intellij.png",65%]

== Next

* xref:system-prerequisites.adoc.adoc[Setup your development environment]
