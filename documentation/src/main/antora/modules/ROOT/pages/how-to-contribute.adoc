...
NOTE: Use values in % for image size. For example; `\image:landscape.png[Landscape,70%,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/landscape.png"]`
...
image:my_image.png[The image,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/my_image.png",300]
...
|image::gallery/widgets/studio/list.png[Studio List,100%,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/gallery/widgets/studio/list.png"]
