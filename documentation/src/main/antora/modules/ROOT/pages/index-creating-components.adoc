...
image:implementing-components.png[Implementing component,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/implementing-components.png",50%]
