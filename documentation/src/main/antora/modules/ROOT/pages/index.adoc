...
https://oss.sonatype.org/service/local/artifact/maven/content?r=snapshots&g=org.talend.sdk.component&a=documentation&v={project_version}-SNAPSHOT&e=pdf&c=all-in-one[link].
endif::[]
