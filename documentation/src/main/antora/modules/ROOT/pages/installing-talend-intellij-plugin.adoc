...
image::intellij/plugin/2-browse-talend.png[Browse talend plugin,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij/plugin/2-browse-talend.png",70%]

[start=6]
. Click the *Restart IDE* button.

image::intellij/plugin/3-restart.png[IDEA restart,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij/plugin/3-restart.png",70%]

[start=7]
. Confirm the IDEA restart to complete the installation.

image::intellij/plugin/4-restart.png[IDEA restart,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij/plugin/4-restart.png",70%]
...
image::intellij/plugin/suggestion_1.png[Keys suggestion,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij/plugin/suggestion_1.png",70%]
