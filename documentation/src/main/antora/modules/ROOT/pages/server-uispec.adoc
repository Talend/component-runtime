...
For the persistence, the framework will fire particular events `OnPersist` and `OnEdit` you can observe
...
IMPORTANT: `OnPersist` will need to become identifier aware of the created entity, ensure to call `setId` please.
