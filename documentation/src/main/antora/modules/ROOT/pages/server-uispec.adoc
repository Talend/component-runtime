...
It is possible to show the help about each property under the inputs.
...
NOTE: This feature is only available with default content of the `@Documentation` annotation of a property. This means that hints are only available in the default language of the component.
