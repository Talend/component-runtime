...
Also note that you can use `@Configuration("prefix")` to inject in a component
a mapping of the `LocalConfiguration`. It uses the same rules as for any configuration object.
