...
+
image::talend_studio_debug_remote_config_1.png[IntelliJ remote configuration, 70%]
. Open Talend Studio.
...
+
image::talend_studio_debug_remote_config_2.png[IntelliJ remote configuration, 70%]
...
+
image::talend_studio_debug_remote_config_3.png[IntelliJ remote configuration, 60%]
