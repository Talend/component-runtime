...
image::studio-reload-button.png[Studio Reload Button,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/studio-reload-button.png",70%]
...
+
image::talend_studio_debug_remote_config_1.png[IntelliJ remote configuration,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/talend_studio_debug_remote_config_1.png",70%]
. Open Talend Studio.
...
+
image::talend_studio_debug_remote_config_2.png[IntelliJ remote configuration,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/talend_studio_debug_remote_config_2.png",70%]
...
+
image::talend_studio_debug_remote_config_3.png[IntelliJ remote configuration,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/talend_studio_debug_remote_config_3.png",60%]
