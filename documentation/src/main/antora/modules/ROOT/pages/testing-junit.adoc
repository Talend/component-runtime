...
<3> We mark all service fields with `@Service` to let the rule inject them before the test is ran
...
<1> We mark all service fields with `@Service` to let the rule inject them before the test is ran
