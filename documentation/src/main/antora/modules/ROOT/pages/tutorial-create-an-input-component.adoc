...
Once implemented, the Partition Mapper configuration is as follows. For more information about Partition Mappers, refer to xref:component-definition.adoc#partition-mapper[this document].
