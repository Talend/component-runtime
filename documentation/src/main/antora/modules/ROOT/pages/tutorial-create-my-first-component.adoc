...
image::tutorial_build_job_run.png[Job run,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_build_job_run.png",70%]
...
+
image::intellij_new_component_project.png[New project,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij_new_component_project.png",70%]
...
+
image::intellij_tutorial_project_metadata.png[Project metadata,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/intellij_tutorial_project_metadata.png",70%]
...
+
image::tutorial_component_configuration_model.png[Configuration Model,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_component_configuration_model.png",70%]
...
+
image::tutorial_component_generic_input.png[Generic Input,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_component_generic_input.png",70%]
...
image::tutorial_generated_project_view.png[Project view,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_generated_project_view.png",70%]
...
+
image::tutorial_intellij_terminal_blank.png[Compile terminal,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_intellij_terminal_blank.png",70%]
...
+
image::tutorial_deploy_in_studio_success.png[Build success,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_deploy_in_studio_success.png",70%]
...
+
image::tutorial_first_component_in_studio.png[Component in Studio,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_first_component_in_studio.png",70%]
...
+
image::tutorial_build_job_trowgenerator.png[tRowGenerator,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_build_job_trowgenerator.png",70%]
4. Validate the *tRowGenerator* configuration.
5. Open the *TutorialFamilyLogger* component and set the *level* field to `info`. +
+
image::tutorial_build_job_logger.png[Logger,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/tutorial_build_job_logger.png",70%]
