...
+
image::jenkins/1_jenkins_new_item.png[Create a new job,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/1_jenkins_new_item.png",70%]
. Enter an Item name (Job name) and choose the freestyle job. Then click OK.
+
image::jenkins/2_jenkins_new_item.png[Create a new job,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/2_jenkins_new_item.png",70%]
...
+
image::jenkins/4_jenkins_source_code.png[Source Code Management,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/4_jenkins_source_code.png",70%]
. In the *Build* section, click *Add build step* and choose *Invoke top-level Maven targets*.
+
image::jenkins/6_jenkins_build_cmd.png[Build Section,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/6_jenkins_build_cmd.png",70%]
. Choose your Maven version and enter the Maven build command. In this case: `clean install`. Then, click *Save*.
+
image::jenkins/6_jenkins_build_cmd_2.png[Build Section,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/6_jenkins_build_cmd_2.png",70%]
+
...
+
image::jenkins/7_jenkins_build_result.png[Test the job,window="_blank",link="https://talend.github.io/component-runtime/main/{version}/_images/jenkins/7_jenkins_build_result.png",70%]
