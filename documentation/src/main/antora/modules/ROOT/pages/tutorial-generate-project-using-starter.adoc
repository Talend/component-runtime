...
+
image::starter/starter_test_facet.png[Test facet,window="_blank",link="_images/starter/starter_test_facet.png",80%]
...
+
image::starter/starter_activate_io.png[Activate IO,window="_blank",link="_images/starter/starter_activate_io.png",80%]
...
image::starter/starter_add_component.png[Input configuration,window="_blank",link="_images/starter/starter_add_component.png",80%]
...
+
image::starter/starter_input-config.png[Input configuration,window="_blank",link="_images/starter/starter_input-config.png",80%]
...
+
image::starter/starter_processor-config.png[Processor configuration,window="_blank",link="_images/starter/starter_processor-config.png",80%]
...
image::starter/starter_output-config.png[Output configuration,window="_blank",link="_images/starter/starter_output-config.png",80%]
...
+
image::starter/starter_project-download.png[Output configuration,window="_blank",link="_images/starter/starter_project-download.png",80%]
