...
+
image::starter_openapi_json.png[Open API toggle,window="_blank",link="https://talend.github.io/component-runtime/main/{page-component-version}/_images/starter_openapi_json.png",80%]
