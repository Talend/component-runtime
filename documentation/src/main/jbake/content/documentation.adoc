...
<plugin>
  ...
  <executions>
    <execution>
      ...
      <configuration>
        <transformers>
          <transformer implementation="org.talend.components.container.maven.shade.ContainerDependenciesTransformer">
...
<plugin>
  ...
  <executions>
    <execution>
      ...
      <configuration>
        <transformers>
          <transformer implementation="org.talend.components.container.maven.shade.PluginTransformer">
            <session>${session}</project>
          </transformer>
        </transformers>
      </configuration>
  ...
  <executions>
    <execution>
      ...
      <configuration>
        ...
        <transformers>
          <transformer
              implementation="org.talend.components.container.maven.shade.ContainerDependenciesTransformer">
...
`org.talend.components.runtime.beam.TalendIO` provides a way to convert a partition mapper or a processor to an input or processor
using the `read` or `write` methods.

==== Processors

`org.talend.components.runtime.beam.TalendFn` provides the way to wrap a processor in a Beam `PTransform` and integrate it in the pipeline.
