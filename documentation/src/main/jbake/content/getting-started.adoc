...
NOTE: if you need to rely on a buffer because you load multiple data at once you can reuse `org.talend.component.api.base.BufferizedProducerSupport` class
