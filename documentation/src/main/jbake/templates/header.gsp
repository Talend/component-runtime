...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>/css/bootstrap.css" media="screen">
    ...
    <![endif]-->
    <link rel="stylesheet" href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>/css/documentation.css">
    <link rel="shortcut icon" href="<%if (content.rootpath) {%>${content.rootpath}<% } else { %><% }%>/images/favicon_0.ico" />
    <style>
