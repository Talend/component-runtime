...
public class DataStoreValidationInputSource implements Serializable {
    private final DataStoreValidationInputMapperConfiguration configuration;

    public DataStoreValidationInputSource(@Option("configuration") final DataStoreValidationInputMapperConfiguration configuration) {
