...
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_CLASS;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_CLAZZ_CLASSLOADER;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_CONNECTOR_CLASSLOADER;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_FROM_LOCATION;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_IS_LOADED;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_MAVEN;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_ROOT_REPOSITORY;
import static org.talend.sdk.component.sample.feature.dynamicdependencies.withdataset.service.DynamicDependenciesService.ENTRY_RUNTIME_CLASSPATH;
...
public class DynamicDependenciesServiceTest {
    ...
    void testloadIterator() {
        ...
        Assertions.assertTrue(record.getString(ENTRY_CONNECTOR_CLASSLOADER).startsWith("jdk.internal.loader.ClassLoaders$AppClassLoader"));
        Assertions.assertNotNull(record.getString(ENTRY_CLAZZ_CLASSLOADER));
        Assertions.assertTrue(record.getString(ENTRY_CLAZZ_CLASSLOADER).startsWith("jdk.internal.loader.ClassLoaders$AppClassLoader"));
