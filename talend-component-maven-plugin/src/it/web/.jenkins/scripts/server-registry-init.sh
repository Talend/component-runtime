...
function create_setenv_script {
  ...
  printf '# Create the setenv.sh script: %s\n' "${_SETENV_PATH}"
  {
    ...
    # TODO test to add language in locale.mapping https://jira.talendforge.org/browse/TCOMP-2378
    # Default is en*=en\nfr*=fr\nzh*=zh_CN\nja*=ja\nde*=de and has to be edited to add more languages (example uk for ukrainian)
