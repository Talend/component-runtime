...
import org.talend.component.maven.legacy.model.CODEGENERATION;
import org.talend.component.maven.legacy.model.COLUMN;
import org.talend.component.maven.legacy.model.COMPONENT;
import org.talend.component.maven.legacy.model.CONNECTOR;
import org.talend.component.maven.legacy.model.CONNECTORS;
import org.talend.component.maven.legacy.model.DEFAULT;
import org.talend.component.maven.legacy.model.DOCUMENTATION;
import org.talend.component.maven.legacy.model.FAMILIES;
import org.talend.component.maven.legacy.model.HEADER;
import org.talend.component.maven.legacy.model.IMPORT;
import org.talend.component.maven.legacy.model.IMPORTS;
import org.talend.component.maven.legacy.model.ITEM;
import org.talend.component.maven.legacy.model.ITEMS;
import org.talend.component.maven.legacy.model.PARAMETER;
import org.talend.component.maven.legacy.model.PARAMETERS;
import org.talend.component.maven.legacy.model.RETURN;
import org.talend.component.maven.legacy.model.RETURNS;
import org.talend.component.maven.legacy.model.TABLE;
    ...
    private static final Collection<IMPORT> MANDATORY_DEPENDENCIES = // mandatory runtime dependencies, = tcomp stack
            Stream.concat(Stream.concat(Stream.of("component-api", "component-spi", "component-runtime-impl",
                    "component-runtime-manager", "component-runtime-di").map(artifactId -> {
                        ...
                        return newImport(artifactId, "mvn:org.talend.components/" + artifactId + "/1.0.0-SNAPSHOT", null);
                    ...
                    })), Stream.of(newImport("container-core", "mvn:org.talend.components/container-core/1.0.0-SNAPSHOT", null),
