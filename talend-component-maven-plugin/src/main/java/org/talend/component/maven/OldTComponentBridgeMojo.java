...
import org.talend.component.runtime.manager.ServiceMeta;
    ...
    private String generateGuessSchema(final ComponentFamilyMeta family, final ComponentFamilyMeta.BaseMeta<?> mapper,
        ...
        if (inputType != null) {
            out.append("    @Override\n"
                    ...
                    .append("            final Object $$converter = $$correctLoader.loadClass(\"org.talend.component.runtime.avro.ComponentModelToIndexeredRecordConverter\")\n")
            ...
            if (guessSchema != null) { // delegate to the action
                ...
                out.append("        return executeInSandbox(\"org.talend.component.runtime.avro.SchemaDiscoverer\", "
