...
import org.talend.sdk.component.runtime.manager.tools.AsciidocDocumentationGenerator;
...
public class AsciidocMojo extends ClasspathMojoBase {
    ...
    public void doExecute() throws MojoExecutionException, MojoFailureException {
        new AsciidocDocumentationGenerator(new File[] { classes }, output, level).run();
    }
}
